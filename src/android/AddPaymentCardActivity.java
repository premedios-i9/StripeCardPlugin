...
import com.fidelidade.stripe3ds.sampleapp.R;
...
public class AddPaymentCardActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setupIntentClientSecret = getIntentExtra("STRIPE_CLIENT_SECRET");
        loadPage();
    }
    ...
    private void loadPage() {
        ...
        Request request = new Request.Builder()
                ...
                .post(body)
                .build();
        publishableKey = getIntentExtra("STRIPE_PUBLISHABLE_KEY");
        stripe = new Stripe(getApplicationContext(), getIntentExtra("STRIPE_PUBLISHABLE_KEY"));

        if (setupIntentClientSecret == "" || setupIntentClientSecret == null) {
        ...
        payButton.setOnClickListener((View view) -> {
            ...
            paymentCard = cardInputWidget.getCard();
    ...
    private String getIntentExtra(String name) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        stripe.onSetupResult(requestCode, data, new ApiResultCallback<SetupIntentResult>() {
            ...
            public void onSuccess(@NonNull SetupIntentResult result) {
                ...
                String paymentMethodID = setupIntent.getPaymentMethodId();
...
//                        }
                    ...
                    resultIntent.putExtra("LAST4", paymentCard.getLast4());
                    resultIntent.putExtra("BRAND", paymentCard.getBrand());
                    resultIntent.putExtra("EXPIRYDATE", String.format("%d/%d", paymentCard.getExpMonth(), paymentCard.getExpYear()));
                    resultIntent.putExtra("TOKEN", setupIntent.getId());
...
//                    });
                    Intent resultIntent = new Intent();
                    resultIntent.putExtra("ERRORMESSAGE", setupIntent.getLastSetupError().message);
